...
def menu():
    ...
    play_button_sprite = paint_api.mount_rect(
        px_x=300, px_y=30, px_w=200, px_h=80,
        key="play",
        title="Play",                
    )
    settings_button_sprite = paint_api.mount_rect(px_x=300, px_y=120, px_w=200, px_h=80, key="settings", bg_color=(0, 0, 200), border_color=(255, 255, 255), title="Settings")
